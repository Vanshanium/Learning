...
is a simple bifurcation point.</div>
						...
						<tr>
							<td class="attributes">&lt;private&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Math.ImplicitPlot.html#searchLine">searchLine</a></b>(fmi, fma, fix, interval, dir, num_components, dataX, dataY, level)
								</div>
...
is a simple bifurcation point.
					...
					<span class="light">{Array}</span>
					<b>searchLine</b>(fmi, fma, fix, interval, dir, num_components, dataX, dataY, level)
