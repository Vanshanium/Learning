...
function AAA() {
    ...
    return (
        <>
            <h1>
                <span>Congurence Rule : </span>
                <span id="Rule">AAA (Angle Angle Angle)</span>
            </h1>
