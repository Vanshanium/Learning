...
function ASA() {
    ...
    useEffect(() => {
        ...
        // Triangle ABC
        var a = board.create('point', [-7, -4], { ...points_atr, name: 'A', fixed: true });

        var b = board.create('point', [-7, 3], { ...points_atr, name: 'B', fixed: true });

        var c = board.create('point', [-2, 0], { ...points_atr, name: 'C', });
    ...
    return (
        <>
            <h1>
                ...
                <span id="Rule">ASA (Angle Side Angle)</span>
            </h1>
